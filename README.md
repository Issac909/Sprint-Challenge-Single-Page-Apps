...
> Answer: When a client side route is clicked, it doesnt require the page to reload. The negative part about client-side routing is it has to load every client side page initially, causing longer initial load times
